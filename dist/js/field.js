...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    var prefix = this.$parent.group.key;
    var fields = this.$parent.group.fields;
    var containers = fields.filter(function (field) {
      return field.component === 'conditional-container';
    });
      ...
      for (var _iterator = containers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        try {
          var _loop = function _loop() {
            ...
            var cleanAttribute = field.attribute.replace("".concat(prefix, "__"), '');

            if (container.expressionsMap.join().includes(cleanAttribute)) {
              var component = _this.findComponentByAttribute(field.attribute, _this.$parent.$children);

              if (component) {
                _this.registerWatcherForFlexible(field.attribute, component);

                _this.resolvers = _this.createResolvers(container.expressions.map(function (string) {
                  return string.replace(cleanAttribute, field.attribute);
                }));
              }
            }
          };
  ...
  computed: {
    fields: function fields() {
      var _this$fieldAttribute$ = this.fieldAttribute.split('conditional_container'),
          _this$fieldAttribute$2 = _slicedToArray(_this$fieldAttribute$, 2),
          prefix = _this$fieldAttribute$2[0],
          suffix = _this$fieldAttribute$2[1];

      return this.field.fields.map(function (field) {
        return field.attribute = prefix + field.attribute + suffix, field;
      });
    },
  ...
  methods: {
    createResolvers: function createResolvers() {
      var _this3 = this;

      var expressions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.field.expressions;
      return expressions.map(function (expression) {
        var parser = new logipar__WEBPACK_IMPORTED_MODULE_1___default.a.Logipar();
        parser.parse(expression);
        return parser.filterFunction(_this3.relationalOperatorLeafResolver);
      });
    },
    ...
    findComponentByAttribute: function findComponentByAttribute(attribute) {
      var children = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.$root.$children;
      ...
      if (children) {
        ...
        try {
          for (var _iterator4 = children[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            var found = this.findComponentByAttribute(attribute, child.$children);
    ...
    registerWatcherForFlexible: function registerWatcherForFlexible(attribute, component) {
      var _this4 = this;
      ...
      component.$once('hook:beforeDestroy', function () {
        return _this4.deleteBagAttribute(attribute);
      });
      component.$watch(watchableAttribute, function (value) {
        console.log(attribute, 'changed');

        _this4.setBagValue(component, attribute, value);
      });
    },
    ...
    fill: function fill(formData) {
      if (this.conditionSatisfied) {
        ...
        try {
          for (var _iterator5 = this.field.fields[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
module.exports = __webpack_require__(/*! C:\Users\rafael\Documents\Code\hublot-backend\conditional-container\resources\js\field.js */"./resources/js/field.js");
