...
Nova.booting(function (Vue, router, store) {
    Vue.component('form-conditional-container', __webpack_require__(2));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_logipar__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_logipar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_logipar__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        ...
        return {
            ...
            resolvers: this.field.expressions.map(function (expression) {
                ...
                var parser = new __WEBPACK_IMPORTED_MODULE_1_logipar___default.a.Logipar();
    ...
    computed: {
        watchableAttributes: function watchableAttributes() {
            ...
            this.parser.walk(function (node) {

                if (node.token.type === 'LITERAL') {
                    var _splitLiteral = _this2.splitLiteral(node.token.literal),
                        _splitLiteral2 = _slicedToArray(_splitLiteral, 1),
                        attribute = _splitLiteral2[0];
    ...
    methods: {
        relationalOperatorLeafResolver: function relationalOperatorLeafResolver(values, literal) {
            var _splitLiteral3 = this.splitLiteral(literal),
                _splitLiteral4 = _slicedToArray(_splitLiteral3, 3),
                attribute = _splitLiteral4[0],
                operator = _splitLiteral4[1],
                value = _splitLiteral4[2];
        ...
        registerDependencyWatchers: function registerDependencyWatchers(components) {
            var _this3 = this;
            ...
            components.forEach(function (component) {
                ...
                if (_this3.field.expressions.join(',').includes(attribute)) {

                    var watchableAttribute = _this3.findWatchableComponentAttribute(component);

                    component.$watch(watchableAttribute, function (value) {

                        _this3.values[attribute] = value;
                        _this3.conditionSatisfied = _this3.resolvers.some(function (resolver) {
                            return resolver(_this3.values);
                        });
                    }, { immediate: true });
                }
            });
        ...
        splitLiteral: function splitLiteral(literal) {
            ...
            var operators = ['===', '==', '=', '!==', '!=', '>=', '<=', '<', '>', 'includes', 'contains', 'truthy', 'ends with', 'starts with'];

            var operator = operators.find(function (operator) {
                return literal.includes(operator);
            });
        ...
        executeConditionStatement: function executeConditionStatement(attributeValue, operator, conditionValue) {
        ...
        fill: function fill(formData) {
            ...
            if (this.conditionSatisfied) {
                ...
                try {
                    ...
                    for (var _iterator = this.field.fields[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
